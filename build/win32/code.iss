...
begin
  ...
  Command :=
    ...
    '$clsid = ''{#FileExplorerContextMenuCLSID}''; ' +
    '$trimmedClsid = $clsid.Trim(''{}''); ' +
    '$bracedClsid = ''{'' + $trimmedClsid + ''}''; ' +
    'Get-CimInstance Win32_Process -Filter ""Name = ''dllhost.exe''"" | ' +
    'Where-Object { $_.CommandLine -like (''*/Processid:'' + $trimmedClsid + ''*'') -or $_.CommandLine -like (''*/Processid:'' + $bracedClsid + ''*'') } | ' +
