	...
	return vscode.languages.registerCompletionItemProvider({ language: 'jsonc', pattern }, {
		provideCompletionItems(document, position, _token) {
			...
			if (isCompletingInsidePropertyStringValue(document, location, position)) {
				...
				return [
					{ label: 'workspaceFolder', detail: vscode.l10n.t("The path of the folder opened in Vector Code") },
					{ label: 'workspaceFolderBasename', detail: vscode.l10n.t("The name of the folder opened in Vector Code without any slashes (/)") },
