 ...
 * like GIT_ASKPASS point to scripts inside the Vector Code installation directory, which
...
/**
 * Checks if the current Vector Code installation is a Windows user or system setup.
 ...
 * This prevents accumulation of old versions when Vector Code updates.
 */
