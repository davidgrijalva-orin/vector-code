...
suite('getFlows', () => {
	...
	const testCases: Array<{ label: string; query: IFlowQuery; expectedFlows: Flows[] }> = [
		{
			label: 'Vector Code Desktop. Local filesystem. GitHub.com',
			query: {
		...
		{
			label: 'Vector Code Desktop. Local filesystem. GitHub Hosted Enterprise',
			query: {
				extensionHost: ExtensionHost.Local,
				isSupportedClient: true,
		...
		{
			label: 'Vector Code Desktop. Local filesystem. GitHub Enterprise Server',
			query: {
				extensionHost: ExtensionHost.Local,
				isSupportedClient: true,
		...
		{
			label: 'Vector Code. Local filesystem. GitHub.com',
			query: {
				extensionHost: ExtensionHost.Local,
		...
		{
			label: 'Vector Code. Local filesystem. GitHub Hosted Enterprise',
			query: {
				extensionHost: ExtensionHost.Local,
				isSupportedClient: false,
				target: GitHubTarget.HostedEnterprise
		...
		{
			label: 'Vector Code. Local filesystem. GitHub Enterprise Server',
			query: {
				extensionHost: ExtensionHost.Local,
				isSupportedClient: false,
				target: GitHubTarget.Enterprise
	...
	suite('preferDeviceCodeFlow configuration', () => {
		...
		test('returns device code flow first when preferDeviceCodeFlow is true - Vector Code Desktop', async () => {
			const config = vscode.workspace.getConfiguration('github-authentication');
