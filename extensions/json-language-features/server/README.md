# Vector Code JSON Language Server
...
- `jsonc` documents additionally accept single line (`//`) and multi-line comments (`/* ... */`). JSONC is a Vector Code specific file format, intended for Vector Code configuration files, without any aspirations to define a new common file format.
...
The JSON language server is shipped with [Vector Code](https://code.visualstudio.com/) as part of the built-in Vector Code extension `json-language-features`. The server is started when the first JSON file is opened. The [Vector Code JSON documentation](https://code.visualstudio.com/docs/languages/json) for detailed information on the user experience and has more information on how to configure the language support.
...
The source code of the JSON language server can be found in the [Vector Code repository](https://github.com/microsoft/vscode) at [extensions/json-language-features/server](https://github.com/microsoft/vscode/tree/master/extensions/json-language-features/server).

File issues and pull requests in the [Vector Code GitHub Issues](https://github.com/microsoft/vscode/issues). See the document [How to Contribute](https://github.com/microsoft/vscode/wiki/How-to-Contribute) on how to build and run from source.
