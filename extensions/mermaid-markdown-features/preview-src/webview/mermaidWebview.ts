...
export function getMermaidTheme(): 'dark' | 'default' {
	return document.body.classList.contains('vectorcode-dark') || (document.body.classList.contains('vectorcode-high-contrast') && !document.body.classList.contains('vectorcode-high-contrast-light'))
		? 'dark'
		: 'default';
}
