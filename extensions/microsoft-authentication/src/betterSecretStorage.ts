...
export class BetterTokenStorage<T> {
	 ...
	 * @param context the vscode Context used to register disposables and retreive the vscode.SecretStorage for this instance of Vector Code
	 */
	...
	// a different window of Vector Code and sends the necessary event if it has.
	...
	private async handleSecretChange(e: SecretStorageChangeEvent) {
		...
		// The KeyList is only a list of keys to aid initial start up of Vector Code to know which
