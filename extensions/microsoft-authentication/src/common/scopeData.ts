...
export class ScopeData {
	 ...
	 * * internal Vector Code scopes (e.g. `VSCODE_CLIENT_ID:...`)
	...
	/**
	 * The list of scopes to send to the token endpoint. This is the same as `scopes` but without the internal Vector Code scopes.
	 */
