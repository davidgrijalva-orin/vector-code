...
declare namespace Fig {
	...
	interface Generator {
		...
		script?:
		| string[]
		| Function<string[], string[] | undefined> // <-- Vector Code edit to make results correct
		| ExecuteCommandInput
		 ...
		 *
		 */
		postProcess?: (out: string, tokens: string[]) => (Suggestion | null)[] | undefined; // <-- Vector Code edit to make results correct
		/**
		...
		) => Promise<(Suggestion | null)[] | undefined>; // <-- Vector Code edit to make results correct
		/**
		 *
