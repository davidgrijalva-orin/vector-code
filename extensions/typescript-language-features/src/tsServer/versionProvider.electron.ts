...
export class DiskTypeScriptVersionProvider implements ITypeScriptVersionProvider {
	...
	public get bundledVersion(): TypeScriptVersion {
		...
		vscode.window.showErrorMessage(vscode.l10n.t("Vector Code\'s tsserver was deleted by another application such as a misbehaving virus detection tool. Please reinstall Vector Code."));
