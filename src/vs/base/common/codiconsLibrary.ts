...
export const codiconsLibrary = {
	...
	vectorcode: register('vectorcode', 0xec1e),
	...
	vectorcodeWarning: register('vectorcode-warning', 0xec38),
	python: register('python', 0xec39),
	vectorcodeLarge: register('vectorcode-large', 0xec3a),
	vectorcodeWarningLarge: register('vectorcode-warning-large', 0xec3b),
	keyboardTab: register('keyboard-tab', 0xec3c),
	vectorcodeBlocked: register('vectorcode-blocked', 0xec3d),
	vectorcodeNotConnected: register('vectorcode-not-connected', 0xec3e),
	...
	vectorcodeUnavailable: register('vectorcode-unavailable', 0xec42),
	...
	vectorcodeInProgress: register('vectorcode-in-progress', 0xec4c),
	vectorcodeError: register('vectorcode-error', 0xec4d),
	vectorcodeSuccess: register('vectorcode-success', 0xec4e),
	...
	vectorcodeSnooze: register('vectorcode-snooze', 0xec52),
