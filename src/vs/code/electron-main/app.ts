...
/**
 * The main Vector Code application. There will only ever be one instance,
...
export class CodeApplication extends Disposable {
	...
	async startup(): Promise<void> {
		this.logService.debug('Starting Vector Code');
		...
		// "com.microsoft.", which breaks native tabs for this app when using this
