				...
				return [
					...
					n.div({
						style: {
							...
							padding: '0px',
							textAlign: 'center',
							background: 'var(--vectorcode-inlineEdit-modifiedChangedTextBackground)',
					...
					n.div({
						style: {
							...
							background: 'var(--vectorcode-inlineEdit-wordReplacementView-background)',
						}
					}, []),
					n.svg({
						viewBox: '0 0 12 18',
						...
						n.svgElem('path', {
							...
							fill: 'var(--vectorcode-inlineEdit-modifiedChangedTextBackground)',
						})
					])
				];
			})
