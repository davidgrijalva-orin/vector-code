...
import { IGalleryMcpServerConfiguration, IMcpServerArgument, IMcpServerInput, IMcpServerKeyValueInput, McpServerConfigurationParseResult, RegistryType } from './mcpManagement.js';
import { IMcpServerVariable, McpServerType, McpServerVariableType } from './mcpPlatformTypes.js';

// Extracted from the upstream MCP management service; shared by marketplace install flows.
export class McpConfigurationConverter {
