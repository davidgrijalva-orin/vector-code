...
// Web environment or unknown
	...
	if (Object.keys(product).length === 0) {
		Object.assign(product, {
			version: '1.104.0-dev',
			nameShort: 'Vector Code Dev',
			nameLong: 'Vector Code Dev',
			applicationName: 'vector-code',
			dataFolderName: '.vector-code-dev',
			urlProtocol: 'vector-code',
			reportIssueUrl: 'https://github.com/davidgrijalva-orin/vector-code/issues/new',
			licenseName: 'MIT',
			licenseUrl: 'https://github.com/davidgrijalva-orin/vector-code/blob/main/LICENSE.txt',
			serverLicenseUrl: 'https://github.com/davidgrijalva-orin/vector-code/blob/main/LICENSE.txt'
		});
	}
}
