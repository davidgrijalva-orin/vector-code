...
export function createApiFactoryAndRegisterActors(accessor: ServicesAccessor): IExtensionApiFactory {
	...
	const disabledExtHostContexts = new Set<ProxyIdentifier<any>>();
	const expected = Object.values<ProxyIdentifier<any>>(ExtHostContext).filter(context => !disabledExtHostContexts.has(context));
