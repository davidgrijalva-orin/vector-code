...
export class DictationWidget extends Disposable implements IContentWidget {
	...
	beforeRender(): IDimension | null {
		...
		this.domNode.style.setProperty('--vectorcode-editor-dictation-widget-height', `${lineHeight}px`);
		this.domNode.style.setProperty('--vectorcode-editor-dictation-widget-width', `${width}px`);
