			...
			<head>
				...
				<style nonce="${nonce}">
					...
					#scroll-to-top {
						...
						right: 25px;
						bottom: 25px;
						background-color: var(--vectorcode-button-secondaryBackground);
					...
					#scroll-to-top:hover {
						background-color: var(--vectorcode-button-secondaryHoverBackground);
					...
					#scroll-to-top span.icon::before {
						content: "";
						display: block;
						background: var(--vectorcode-button-secondaryForeground);
						/* Chevron up icon */
