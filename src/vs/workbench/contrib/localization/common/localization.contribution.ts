						...
						translations: {
							...
							items: {
								...
								properties: {
									id: {
										type: 'string',
										description: localize('vscode.extension.contributes.localizations.translations.id', "Id of Vector Code or Extension for which this translation is contributed to. Id of Vector Code is always `vscode` and of extension should be in format `publisherId.extensionName`."),
