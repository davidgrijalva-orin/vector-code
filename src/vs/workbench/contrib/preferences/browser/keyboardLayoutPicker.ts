...
const DEFAULT_CONTENT: string = [
	`// ${nls.localize('displayLanguage', 'Defines the keyboard layout used in Vector Code in the browser environment.')}`,
	`// ${nls.localize('doc', 'Open Vector Code and run "Developer: Inspect Key Mappings (JSON)" from Command Palette.')}`,
	``,
