...
export const enum TerminalCommandId {
	...
	SendSelectionToTerminalInput = 'workbench.action.terminal.sendSelectionToTerminalInput',
	SendSelectionToAgentTerminal = 'workbench.action.terminal.sendSelectionToAgentTerminal',
...
export const DEFAULT_COMMANDS_TO_SKIP_SHELL: string[] = [
	...
	TerminalCommandId.SendSelectionToTerminalInput,
	TerminalCommandId.SendSelectionToAgentTerminal,
