			...
			<head>
				...
				<style nonce="${nonce}">
					...
					code:has(.codesetting) {
						background-color: var(--vectorcode-textPreformat-background);
						color: var(--vectorcode-textPreformat-foreground);
						padding-left: 1px;
						margin-right: 3px;
						padding-right: 0px;
					}
					...
					code:has(.codesetting):focus {
						border: 1px solid var(--vectorcode-button-border, transparent);
					}
					...
					.codesetting svg {
						...
						text-align: center;
						cursor: pointer;
						border: 1px solid var(--vectorcode-button-secondaryBorder, transparent);
					...
					.codesetting:hover {
						color: var(--vectorcode-textPreformat-foreground) !important;
					...
					.codesetting:focus {
						outline: 0 !important;
						text-decoration: none !important;
						color: var(--vectorcode-button-hoverForeground) !important;
					}
					.codesetting .separator {
						...
						margin-bottom: -3px;
						display: inline-block;
						background-color: var(--vectorcode-editor-background);
						font-size: 12px;
						margin-right: 4px;
					}
					...
					#scroll-to-top {
						...
						right: 25px;
						bottom: 25px;
						background-color: var(--vectorcode-button-background, #444);
						border-color: var(--vectorcode-button-border);
						border-radius: 50%;
						cursor: pointer;
					...
					#scroll-to-top:hover {
						background-color: var(--vectorcode-button-hoverBackground);
						box-shadow: 2px 2px 2px rgba(0,0,0,.25);
					}

					body.vectorcode-high-contrast #scroll-to-top {
						border-width: 2px;
						border-style: solid;
						box-shadow: none;
					}
					...
					#scroll-to-top span.icon::before {
						content: "";
						display: block;
						background: var(--vectorcode-button-foreground);
						/* Chevron up icon */
					...
					#toc-nav a {
						color: var(--vectorcode-editor-foreground, #ccc);
						text-decoration: none !important;
					...
					#toc-nav a:hover {
						background-color: var(--vectorcode-button-secondaryHoverBackground, #1177bb);
						color: var(--vectorcode-button-secondaryForeground, #ffffff);
						cursor: pointer;
						text-decoration: none !important;
					}
