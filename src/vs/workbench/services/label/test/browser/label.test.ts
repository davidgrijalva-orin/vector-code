...
suite('multi-root workspace', () => {
	...
	test('stripPathSegments strips leading path segments', () => {
		...
		const uri = URI.from({ scheme: 'test-scoped', authority: 'my-server', path: '/file//home/user/project/file.ts' });
	...
	test('stripPathSegments combined with stripPathStartingSeparator', () => {
		...
		const uri = URI.from({ scheme: 'test-scoped', authority: 'my-server', path: '/file//home/user/file.ts' });
		const generated = labelService.getUriLabel(uri, { relative: false });
